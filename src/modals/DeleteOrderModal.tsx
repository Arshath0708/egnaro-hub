  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      >
        ...
        <h2 className="text-2xl font-black text-white tracking-wide">Delete Order</h2>
        <p className="mt-3 text-xs text-gray-400 leading-relaxed max-w-xs mx-auto">
          Are you sure you want to delete order <span className="font-extrabold text-white block my-1 text-sm">#{order.shipment_id || order.order_id}</span> for customer <span className="text-white font-extrabold">{order.customer_name}</span>?
          <br /><br />
          This action is permanent and will delete all related shipment details, items, checkpoints, and histories across the platform.
        </p>
