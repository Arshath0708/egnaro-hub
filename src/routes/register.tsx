...
export default function Register() {   
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#080c14] overflow-hidden flex items-center justify-center p-3 sm:p-4">
      ...
      {/* Main Container */}
      <div className="relative z-10 w-full max-w-lg my-6 sm:my-12">
        <motion.div
          initial={{ opacity: 0, y: 8 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.25, ease: "easeInOut" }}
          className="relative rounded-[24px] border border-white/5 bg-[#0e1422]/90 p-5 sm:p-8 md:p-10 shadow-[0_25px_60px_rgba(0,0,0,0.5)] backdrop-blur-2xl overflow-hidden w-full"
        >
