      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <motion.div
            ...
            className="relative aspect-square overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl backdrop-blur-xl"
          >
            <img
              src={product.image}
              alt={product.name}
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-4">
              <div className="flex items-center rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl">
                <button
                  onClick={() =>
                    setQty((q) =>
                      Math.max(
