  ...
  return (
    <Shell>
      <div className="mx-auto max-w-7xl px-4 py-6 md:py-10 animate-fadeUp">
        ...
        {/* STATS */}
        <div className="mb-10 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard
        ...
        <Tabs
          ...
          className="w-full"
        >
          <TabsList className="mb-10 hidden md:grid md:grid-cols-3 h-auto w-full gap-3 rounded-[28px] bg-white/[0.02] p-2 border border-white/5">
            <TabsTrigger
              value="orders"
