      ...
      <Link to={`/product/${product.id}`} className="flex flex-1 flex-col">
        ...
        <div className="relative aspect-[4/5] overflow-hidden bg-black/40">
          ...
          <div className="absolute inset-x-3 top-3 flex justify-between items-start">
            ...
            {product.is_new && (
              <div className="rounded-full bg-emerald-500/10 border border-emerald-500/30 px-3.5 py-1 font-mono text-[0.68rem] font-black uppercase tracking-[0.1em] text-emerald-400 shadow-lg backdrop-blur-md">
                NEW
              </div>
            )}
          </div>
        ...
        <div className="flex flex-1 flex-col p-4 sm:p-5">
          ...
          <div className="mb-3 flex items-center justify-between">
             <div className="flex items-center gap-1.5">
              <div className="flex items-center gap-1 rounded-full bg-yellow-500/10 border border-yellow-500/20 px-2 py-0.5">
                <svg className="h-3 w-3 fill-yellow-500 text-yellow-500 drop-shadow-[0_2px_4px_rgba(234,179,8,0.2)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                </svg>
                <span className="font-mono text-[0.68rem] font-bold text-yellow-500">
                  {rating.toFixed(1)}
                </span>
              </div>
            ...
            <span className="font-mono text-[0.65rem] font-bold uppercase tracking-[0.12em] text-slate-400 bg-white/5 border border-white/5 rounded-md px-1.5 py-0.5">
